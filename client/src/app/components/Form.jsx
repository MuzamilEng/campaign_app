  ...
  return (
    <main className="flex w-full justify-center p-[1vw] items-center">
      ...
      <section className="bg-white max-w-[55vw] w-full p-[1vw]">
        ...
        >
          <Icon
            className="text-[3vw] text-blue-700"
            icon="fluent:folder-add-20-regular"
          />
          <p className="text-[1vw] font-medium mt-[0.7vw] text-black">
            Click to Upload or Drop CSV here
          </p>
          ...
          <button
            className="mt-[1vw] bg-blue-700 w-full max-w-[6vw] hover:bg-blue-800  text-center items-center flex justify-center text-white p-[0.7vw] rounded-md"
            type="submit"
          >
            <Icon icon="formkit:submit" className="text-[1vw]" />
            Submit
          </button>
        </form>
      </section>
