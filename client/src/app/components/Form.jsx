  ...
  return (
    <main className="flex w-full justify-center p-[1vw] items-center">
      ...
      >
        ...
        <button className="mt-[1vw] bg-blue-700 w-full max-w-[6vw] hover:bg-blue-800  text-center items-center flex justify-center text-white p-[0.7vw] rounded-md" type="submit"><Icon icon="formkit:submit" className="text-[1vw]" />Submit</button>
      </form> 
